...
echo ""
echo "### This example demonstrates how to build and link against a static library."
echo ""
...
run_command "Compile all the source files, creating all the object files" "clang -c *.c"

list_directory_contents "Current"

run_command "Create a static library with the print functions" "ar -rs ${PRINT_ARCHIVE_LIBRARY} ${PRINT_HELLO}.o ${PRINT_GOODBYE}.o"

run_command "Delete the print object files" "rm ${PRINT_HELLO}.o ${PRINT_GOODBYE}.o"

list_directory_contents "Current"

run_command "Run the linker to create the executable file ${PROGRAM}" "clang ${PROGRAM}.o ${PRINT_ARCHIVE_LIBRARY} -o ${PROGRAM}"
